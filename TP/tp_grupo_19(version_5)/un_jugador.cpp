...
system("color 97");// le cambia el color de fondo y el de la letra
...
string ingresar_Nombre() {
    string nombre;
    cout <<endl<< "\t" << "Bienvenido jugador!" << endl;
...
void lanzar_Dados_Defensores(int vdefensa[], int dados_defensores,string nombre) {
    system("cls");
    cout<<"Lanzando dados defensores de "<<nombre<<endl<<endl;
...
void maestro( int &dados_restantes, string nombre){
    ...
    cout<<"\t \t UN MOMENTO!!.....SILENCIO TODOS!!";
    puntos_suspensivos(".", 2, 1);
    cout<< endl<<endl;
    cout<<"\t \t OHH estamos en presencia del GRAN MAESTRO,";
    puntos_suspensivos(".", 2, 1);
    cout<< endl<<endl;
    cout<<"\t \t  .....(hace un reverencia)"<< endl << endl;
    cout<<"Permitame ofrecerle un trato especial";
    puntos_suspensivos(".", 2, 1);
    cout<< endl<<endl;
    cout<<"si promete ante el universo que dara por aprobado este trabajo practico le dare Un dado extra! :o";
    puntos_suspensivos(".", 2, 1);
    cout<< endl<<endl;
    cout<<"pero si solo tendra nueve o diez en su teclado a la hora de calificar, le dare DOS dados extras!!  XD";
     puntos_suspensivos(".", 2, 1);
    cout<< endl<<endl;
    cout<<".....sin presiones, usted decide...";
     puntos_suspensivos(".", 2, 1);
    cout<< endl<<endl<<endl;
