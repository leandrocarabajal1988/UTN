...
rlutil::setBackgroundColor(rlutil::GREY);
rlutil::locate(x+1,y+7);
cout<< (char)223;
rlutil::locate(x+1,y+8);
cout<< (char)219;
rlutil::setColor(rlutil::BLACK);
rlutil::setBackgroundColor(rlutil::LIGHTRED);
}
...
//--------------------------------ESCUDOS RESTANTES---------------------------------
void cascos_restantes_inanimados(int x, int y, int cantidad_dados){
...
//-------------------------------- LANZAS RESTANTES---------------------------------
void lanza_restantes(int x, int y, int cantidad_dados){
...
////-------------------------------------------- PLANTILLA-------------------------------------------------
void plantilla (int ronda_numero, string nombre, int tirada_numero, int dados_restantes, int dados_defensores, int puntos_totales){
...
cascos_restantes_inanimados(6, 24, dados_defensores);
...
rlutil::locate(108, 3);
cout<< " PUNTAJE TOTAL: " << puntos_totales;
