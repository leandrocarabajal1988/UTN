...
//-----------------------------------------INGRESO DE JUGARORES----------------------------------------
    plantilla (cont_rondas, "jugador misterioso 1", cont_tirada1, dados_restantes1, dados_defensores, puntos_totales1);
...
//---------------------------------------LANZAMIENTO DE DADOS DEFENSIVOS jugador 1------------------------
    plantilla (cont_rondas, nombre1, cont_tirada1, dados_restantes1, dados_defensores, puntos_totales1);
...
//---------------------------------------LANZAMIENTO DE DADOS DEFENSIVOS jugador 2------------------------
    plantilla (cont_rondas, nombre2, cont_tirada2, dados_restantes2, dados_defensores, puntos_totales2);
...
//----------------------------------------PANTALLA DE MENSAJE DE SISTEMA--------------------------
    ...
    rlutil::setColor(rlutil::GREY);
    rlutil::locate(108, 12);
    texto_letras("Excelente! COMENCEMOS!", 10000);
    rlutil::msleep(2000);
...
//--------------------------------------ETAPA DADAOS ATACANTES JUGADOR UNO-----------------------------------
    ...
    do{
        ...
        do //para jugador 1
        {
            ...
            cout<<nombre1;
            rlutil::locate(108, 16);
            texto_letras("LANZA LOS DADOS DE ATAQUE", 10000);
            rlutil::locate(108, 18);
          ...
          //---------------------(CADA VEZ QUE LANZO LOS DADOS LIMPIO LA PANTALLA)----------------
            plantilla (cont_rondas, nombre1, cont_tirada1, dados_restantes1, dados_defensores, puntos_totales1);
            tirar_dados_sin_sombra(38, 13, dados_restantes1, vataque1);
            ...
            espadas_restantes(44, 9 , dados_restantes1);
            tirar_dados_sin_sombra(56, 26, dados_defensores, vdefensa1);
...
//-------------------------------------ETAPA DE ELIMINACION DE DADOS JUGADOR DOS---------------------------------
        do //para jugador 2
        {
         ...
         //---------------------(CADA VEZ QUE LANZO LOS DADOS LIMPIO LA PANTALLA)----------------
            plantilla (cont_rondas, nombre2, cont_tirada2, dados_restantes2, dados_defensores, puntos_totales2);
            tirar_dados_sin_sombra(38, 13, dados_restantes2, vataque2);
            ...
            for(int i=0; i<dados_restantes2; i++)
            {
              ...
              //-----------------------------BATALLA GRAFICA DE DADOS-----------------------------
            espadas_restantes(44, 9 , dados_restantes2);
            tirar_dados_sin_sombra(56, 26, dados_defensores, vdefensa2);
            cascos_restantes(57, 24, dados_defensores);
            lanza_restantes(62, 19, dados_defensores);
    ...
    plantilla(0, "RESULTADOS", 0, 7, 3, 9999);
    rlutil::setColor(rlutil::GREY);
    rlutil::locate(108, 12);
